...
**Files:**
- Create: `us/supabase/migrations/0008_viajes_storage.sql`
...
```sql
-- supabase/migrations/0008_viajes_storage.sql
...
Run: `supabase db push`
Expected: muestra `0008_viajes_storage.sql`, confirmas con `Y`, termina con "Finished supabase db push."
...
```bash
git add supabase/migrations/0008_viajes_storage.sql
